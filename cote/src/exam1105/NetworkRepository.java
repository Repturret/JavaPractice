...
public class NetworkRepository implements MemoRepository {
	...
	public void addMemo(String id, String body) {
		...
		System.out.println("네트워크 위치에 " + id + " 메모가 저장되었습니다.");
	...
	public void getMemo() {
		...
		System.out.println("네트워크 위치의 메모를 조회합니다.");
	...
	public void deleteMemo(String id) {
		...
		System.out.println("네트워크 위치의 " + id + " 메모를 삭제하였습니다.");
	...
	public void updateMemo(String id, String body) {
		...
		System.out.println("네트워크 위치의 " + id + " 메모가 수정되었습니다.");
